    ...
    <div>
        <div class="roadmap-modal" v-if="visible" style="width: 320px">
            ...
            <div class="body">
                ...
                <label for="appovers">Appover</label>
                <input class="form-control" id="name" v-model="nodeForm.appovers"/>
...
<script>
  ...
  export default {
    ...
    data: function() {
      return {
        nodeForm: {name: null, id: null, type: null, appovers: null},
    ...
    methods: {
      handleClickSaveNode() {
        this.$emit('update:node', Object.assign(this.node, {
          ...
          appovers : this.nodeForm.appovers,
    ...
    watch: {
      node: {
        ...
        handler(val) {
          ...
          this.nodeForm.appovers = val.appovers
